...
export const businessMain = {
  ...
  Section_seller_ir_Heading:
    "already over 17,000\nCreator at <img alt='' src='' data-icon-rainbow/> Marple Shop\nare active.",
  ...
  Section_seller_ir_P_live:
    "YouTube linked\nLive Commerce <img alt='' src='' data-icon-youtube/>,",
  Section_seller_ir_P_Overseas:
    "Overseas payment and delivery <img alt='' src='' data-icon-american-flag/>",
  Section_plus_Heading:
    "Webtoon, character, MCN,\nGame company intellectual property rights\nFor companies with <img alt='' src='' data-icon-ip-letter/>\nContent Commerce Platform\nMarple Shop Plus",
  Section_plus_P:
    "saving time and money\nWe provide one-stop business solutions.",
  Section_plus_A_apply:
    "<img alt='' src='' data-icon-marpple-char1/>Apply for Plus",
  Section_plus_A_intro:
    "<img alt='' src='' data-icon-marpple-char2/>Learn more",
  ...
  Section_partners_A_apply:
    "<img alt='' src='' data-icon-marpple-char1/>Apply for Partners",
  Section_partners_A_intro:
    "<img alt='' src='' data-icon-marpple-char2/>Learn more",
};
